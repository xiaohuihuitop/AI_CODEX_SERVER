...
- 官方 Codex `26.810.7004.0` 在另一台 Windows 电脑完成只读兼容检测：CDP 连接成功，识别 24 条侧栏线程，编辑器与发送/停止按钮均通过。已新增独立 `codex-desktop-26.810.7004` 档案；其他 `26.810` 版本继续拒绝，真实发送与停止仍需在该电脑完成验收。
